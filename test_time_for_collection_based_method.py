...
c_dir = '/data/jsy/datasets/Places365/data_for_time_test_resized_768'
c_name_list = os.listdir(c_dir)
s_path = '/data/jsy/datasets/wikiart/Artists/paul-cezanne/0006_apples, pears and gr_1880.jpg'
style = style_tf(Image.open(s_path)).unsqueeze(0).to(device)

time_file = open('time_768.txt', 'w')
sum_time = 0.
cnt = 0
for c_name in c_name_list:
    ...
    print(used_time, file=time_file)

avg_time = sum_time / (cnt-1)
print(f'avg_time = {avg_time}')
print(f'avg_time = {avg_time}', file=time_file)
time_file.close()